...
type CategoryUpParam struct {
	...
	Id            string                 `protobuf:"bytes,2,opt,name=id,proto3" json:"id,omitempty"`                      // カテゴリID
	Name          string                 `protobuf:"bytes,3,opt,name=name,proto3" json:"name,omitempty"`                  // カテゴリ名
...
type ProductUpParam struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Crud          CRUD                   `protobuf:"varint,1,opt,name=crud,proto3,enum=proto.CRUD" json:"crud,omitempty"`              // 更新の種類
	Id            string                 `protobuf:"bytes,2,opt,name=id,proto3" json:"id,omitempty"`                                   // 商品ID
	Name          string                 `protobuf:"bytes,3,opt,name=name,proto3" json:"name,omitempty"`                               // 商品名
	Price         int32                  `protobuf:"varint,4,opt,name=price,proto3" json:"price,omitempty"`                            // 商品価格
	CategoryId    string                 `protobuf:"bytes,5,opt,name=category_id,json=categoryId,proto3" json:"category_id,omitempty"` // カテゴリID
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
